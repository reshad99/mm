        ...
        <div class="card card-primary">
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" id="inputName" value="{{$action->title_az}}" name="title_az" class="form-control">
            ...
            <div class="form-group">
                ...
                <input type="text" id="inputName" value="{{$action->title_en}}" name="title_en" class="form-control">
            ...
            <div class="form-group">
              ...
              <input type="text" id="inputName" value="{{$action->title_ru}}" name="title_ru" class="form-control">
            ...
            <div class="form-group">
              ...
              <textarea id="summernote1" name="text_az">{!!$action->text_az!!}</textarea>
            ...
            <div class="form-group">
              ...
              <textarea id="summernote2" name="text_en">{!!$action->text_en!!}</textarea>
            ...
            <div class="form-group">
              ...
              <textarea id="summernote3" name="text_ru">{!!$action->text_ru!!}</textarea>
            ...
            {{-- <div class="form-group">
                ...
                <input type="text" id="inputName" value="{{$action->slug}}" name="slug" class="form-control">
              @if ($errors->first('slug'))
                  <span class="alert alert-danger">{{$errors->first('slug')}}</span>
              @endif
            </div> --}}
            <div class="form-group">
                <label for="inputProjectLeader">Başlıq Şəkil</label><br>
            ...
            <div class="form-group">
              <label for="inputProjectLeader">Cover</label><br>
            <input type="file" name="cover" id="">
            @if ($errors->first('cover'))
                <span class="alert alert-danger">{{$errors->first('cover')}}</span>
            @endif
          </div>
          </div>
        </div>
